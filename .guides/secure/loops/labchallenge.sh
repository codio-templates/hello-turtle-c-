...
g++ code/loops/labchallenge.cpp -o code/loops/labchallenge -L/usr/X11R6/lib -lm -lpthread -lX11
...
OXO" ]; then 
  echo "<br/><hr/><h3>Challenge Feedback</h3>"
  echo "Your code is not outputing the correct pattern. It is outputting: "
  echo "$OUTPUT1"
  exit 1
fi
